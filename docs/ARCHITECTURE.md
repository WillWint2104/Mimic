...
| **Native Node addon (custom)**    | Always an option — call `SendInput` directly via N-API.                                                                                                                                                                                                         | Full control.                                                                                                                                                                                                                                            | Significant up-front work for what either `@nut-tree-fork/nut-js` or `robotjs` already gives us. Only worth it if both higher-level options stagnate.                                                    |
